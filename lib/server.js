...
(function() {
  var ACCEPT_ANY_RTSP_URLS, DOCUMENT_ROOT, DO_SPAWN_PICAM, ENABLE_DEBUG_RTSP_URL, PICAM_CWD, PICAM_PATH, PICAM_UID, REC_DIR, SERVER_NAME, STREAM_TOKEN_LIFETIME, StreamServer, fs, path, picam, spawn, startStreamProcess, streamServer, url;
  ...
  startStreamProcess = function() {
    ...
    picam = spawn('nice', ['-n', '-20', 'ionice', '-c1', '-n0', 'sudo', '-u', "#" + PICAM_UID, PICAM_PATH, '--rtspout', '--alsadev', 'hw:1,0'], {
      cwd: PICAM_CWD,
      env: process.env
    });
